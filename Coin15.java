...
public class Coin15 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// login
		Thread.sleep(2000);
		driver.findElement(By.id("text")).sendKeys("bluestar2@gmail.com");
		...
		Thread.sleep(1000);
		js.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=100");
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		js2.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=1500");
		Thread.sleep(2000);
