...
public class Coin6 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * driver.findEleme
		 * nt(By.xpath("(//td[@class='w-[10%]']//button)[30]")).click();
		 * driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		...
		Thread.sleep(1000);
		js2.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=2100");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[29]")).click();
		...
		Thread.sleep(2000);
		js1.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=2200");
		Thread.sleep(2000);
