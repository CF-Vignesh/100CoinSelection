...
public class Coin11 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// login
		Thread.sleep(2000);
		driver.findElement(By.id("text")).sendKeys("bluestar6@gmail.com");
		...
		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[22]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		driver.findElement(By.xpath("//button[text()='1x']/..")).click();

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[23]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		driver.findElement(By.xpath("//button[text()='5x']/..")).click();

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[24]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		...
		Thread.sleep(1000);
		js2.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=300");
		Thread.sleep(2000);

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[5]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		driver.findElement(By.xpath("//button[text()='1x']/..")).click();
		...
		Thread.sleep(2000);
		js1.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=1000");
		Thread.sleep(2000);

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[13]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		driver.findElement(By.xpath("//button[text()='2x']/..")).click();

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[14]")).click();
		driver.findElement(By.xpath("//button[text()='Up']/../..")).click();
		driver.findElement(By.xpath("//button[text()='2x']/..")).click();

		/*
		 * driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[15]")).click();
		 * driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		 * driver.findElement(By.xpath("//button[text()='5x']/..")).click();
		 */
