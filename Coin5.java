...
public class Coin5 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// login
		Thread.sleep(2000);
		driver.findElement(By.id("text")).sendKeys("vickyspcet2020@gmail.com");
		...
		// join now
		driver.findElement(By.xpath("(//span[contains(@class,'flex gap-1 lg:gap-2 items-center justify-center')])[2]"))
				.click();
		...
		Thread.sleep(1000);
		js.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=200");
		Thread.sleep(2000);

		// low cap (+)

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[6]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		driver.findElement(By.xpath("//button[text()='1x']/..")).click();

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[7]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		driver.findElement(By.xpath("//button[text()='5x']/..")).click();

		/*
		 * driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[30]")).click();
		 * driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		...
		Thread.sleep(1000);
		js2.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=2200");
		Thread.sleep(2000);

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[31]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		driver.findElement(By.xpath("//button[text()='1x']/..")).click();

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[32]")).click();
		driver.findElement(By.xpath("//button[text()='Up']/../..")).click();
		driver.findElement(By.xpath("//button[text()='3x']/..")).click();

		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[33]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		...
		Thread.sleep(2000);
		js1.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=200");
		Thread.sleep(2000);
