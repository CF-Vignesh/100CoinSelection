...
public class Coin7 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		js.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=300");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[11]")).click();
		driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		...
		Thread.sleep(2000);
		js1.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=2000");
		Thread.sleep(2000);
