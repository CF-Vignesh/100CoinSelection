...
public class Coin14 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// login
		Thread.sleep(2000);
		driver.findElement(By.id("text")).sendKeys("bluestar1@gmail.com");
		 ...
		 * js.executeScript(
		 * "document.querySelector(\"div[id='coinLister']\").scrollTop=100");
		 * Thread.sleep(2000);
		 */
		// low cap (+)
		...
		Thread.sleep(1000);
		js2.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=1800");
		Thread.sleep(2000);
		...
		/*
		 * driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[19]")).click();
		 * driver.findElement(By.xpath("//button[text()='Down']/../..")).click();
		...
		Thread.sleep(2000);
		js1.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=1400");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//td[@class='w-[10%]']//button)[16]")).click();
		driver.findElement(By.xpath("//button[text()='Up']/../..")).click();
		driver.findElement(By.xpath("//button[text()='2x']/..")).click();
