...
public class Coin13 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		js.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=1400");
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		js2.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=1300");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		js1.executeScript("document.querySelector(\"div[id='coinLister']\").scrollTop=100");
		Thread.sleep(2000);
